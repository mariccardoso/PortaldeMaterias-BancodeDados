...
As lacunas da frase acima devem ser preenchidas, respectivamente, por', 'a) o aminoácido; III', 'b) a amina; II', 'c) o aminoácido; I', 'd) o fenol; I', 'e) a amina; III', 'E', 4),
...
('Questão05: (UFMG) Algumas propriedades físicas são características do conjunto das moléculas de uma substância, enquanto outras são atributos intrínsecos a moléculas individuais. Assim sendo, é CORRETO afirmar que uma propriedade intrínseca de uma molécula de água é a:', 'a) densidade', 'b) polaridade', 'c) pressão de vapor', 'd) temperatura de ebulição', 'e) geometria molecular.', 'A', 4),
('Questão06: (FUVEST) Uma usina de reciclagem de plástico recebeu um lote de ras pas de 2 tipos de plásticos, um deles com densidade 1,10 kg/L e outro com densidade 1,14 kg/L. Para efetuar a sparação dos dois tipos de plásticos, foi necessário preparar 1000 L de uma solução de densidade apropriada, misturando-se volumes adequados de água (densidade = 1,00 kg/L) e de uma solução aquosa de NaCl, disponível no almoxarifado da usina, de densidade 1,25 kg/L. Esses volumes, em litros, podem ser, respectivamente,', 'a) 900 e 100', 'b) 800 e 200', 'c) 500 e 500', 'd) 200 e 800', 'e) 100 e 900', 'C', 4),
...
-- Todas as questões que tem a alternativa E como resposta correta
SELECT * FROM questoes WHERE resposta_correta = 'E';

-- Todas as questões que tem a alternativa E como resposta correta e que pertencem ao simulado 1
SELECT * FROM questoes WHERE resposta_correta = 'E' AND id_simulado = 1;
